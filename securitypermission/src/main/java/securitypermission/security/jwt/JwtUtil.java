package securitypermission.security.jwt;
...
import securitypermission.security.config.BeanFactory;
...
public class JwtUtil{
    ...
    public static UserEntity getUser(HttpServletRequest request){
        ...
        return BeanFactory.getUserMangementFegin().findByUserName(parseToken(token).getUsername());
