...
import securitypermission.security.fegin.MenuMangementFegin;
import securitypermission.security.fegin.RoleMangementFegin;
import vo.view.Node;
...
public class RoleServiceImpl implements RoleService {
    ...
    @Override
    public List<RoleMenuView> getRoleMenuMsg(UserEntity user) {

        List<Menu> menus = Backtrack.checkData(roleMangementFegin.getMenuByRId(user.getId()));
